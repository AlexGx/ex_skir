...
defmodule SkirOut.Methods do
  @moduledoc false
  use Skir.Methods

  method :my_procedure, 674_706_602,
    request: SkirOut.Point,
    response: SkirOut.JsonValue,
    doc: "My procedure"

  method :with_explicit_number, 3,
    request: {:array, SkirOut.Point},
    response: {:optional, SkirOut.JsonValue}

  method :true_, 78_901, request: :string, response: :string
end
